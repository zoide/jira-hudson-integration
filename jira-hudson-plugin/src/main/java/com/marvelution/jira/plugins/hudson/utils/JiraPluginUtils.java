 ...
 */
public final class JiraPluginUtils {

	private static final JiraPluginUtils INSTANCE = new JiraPluginUtils();
	 ...
	 * Private constructor
	 */
	private JiraPluginUtils() {
		final InputStream input = getClass().getResourceAsStream("JiraPluginUtils.properties");
		try {
			PROPERTIES.load(input);
		} catch (IOException e) {
			throw new RuntimeException("Failed to load JIRA Plugin properties", e);
		}
	}
