...
import com.marvelution.jira.plugins.hudson.charts.BuildTestResultRatioChartGenerator;
...
public class ChartTest {
	...
	public void testBuildTestResultsRatioChart() throws IOException {
		...
		ChartHelper chart = new BuildTestResultRatioChartGenerator(server, job, i18nHelper).generateChart();
		chart.generate(500, 500);
		System.out.println(chart.getImageMap());
		System.out.println(System.getProperty("java.io.tmpdir") + chart.getLocation());
	}
